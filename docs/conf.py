...
release = version = typecheck_runner.__version__
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/typecheck-runner",
...
htmlhelp_basename = "typecheck_runnerdoc"
...
latex_documents = [
    (
        master_doc,
        "typecheck_runner.tex",
        "typecheck-runner Documentation",
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(typecheck_runner.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/typecheck-runner/blob/{html_context['github_version']}/src/typecheck_runner/{fn}{linespec}"
