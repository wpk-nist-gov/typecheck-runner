...
[issues]: https://github.com/wpk-nist-gov/typecheck-runner/issues
<!-- prettier-ignore-end -->
...
- Clone your fork locally:
  ...
  ```bash
  git clone git@github.com:your_name_here/typecheck-runner.git
  ```
  ...
  ```bash
  git clone --recursive-submodules git@github.com:your_name_here/typecheck-runner.git
  ```
